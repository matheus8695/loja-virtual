<x-drawer wire:model='modal' title="Alterar Endereço" class="w-1/3 p-4" right>
    <x-form wire:submit='update' id="update-address-form">
        <hr class="my-5">
        ...
        <x-slot:actions>
            ...
            <x-button label="Cadastrar" type="submit" form="update-address-form"/>
        </x-slot:actions>
    </x-form>
</x-drawer>